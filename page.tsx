        ...
        <div className="bg-white min-h-screen p-12 flex flex-wrap items-center justify-center relative">
            ...
            <div className="bg-blue-100 col-span-3 h-72 p-7 flex flex-col justify-between rounded-4xl text-blue-950 relative">
                <div className="flex gap-3 items-center font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-palette">
            ...
            <div className="bg-green-100 col-span-3 h-72 p-7 flex flex-col justify-between rounded-4xl text-green-950 relative">
                <div className="flex gap-3 items-center font-medium">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-terminal-2">
	                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div className="bg-orange-100 col-span-2 h-72 p-7 flex flex-col justify-between rounded-4xl text-orange-800">
                <div className="flex gap-3 items-center font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-code">
	                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
